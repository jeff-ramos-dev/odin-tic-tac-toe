...
function ScreenController() {
  ...
  const setPlayerNames = () => {
    ...
    game.players[0].name = playerOne.value ? playerOne.value : game.players[0].name
    game.players[1].name = playerTwo.value ? playerTwo.value : game.players[1].name
    heading.textContent = `${game.players[0].name}'s turn`
  }
